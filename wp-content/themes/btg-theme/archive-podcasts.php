<?php get_header(); ?>
    ...
    <?php if( have_rows('podcast_top', 'option') ) : while( have_rows('podcast_top', 'option') ) : the_row(); ?>
        <section class="ra-top pod-top" style="background: url('<?=get_sub_field('pod_bg');?>') no-repeat bottom center / cover;">
            <div class="container">
                <div class="row">
                ...
                <div class="col-12">
                    <div class="pods">
                        ...
                        ?>
                                ...
                                <div class="single-pod <?php if($hov_img) { echo 'has-hover'; } ?>" data-aos="fade-up" data-aos-delay="200">
                                    <div class="inner">
